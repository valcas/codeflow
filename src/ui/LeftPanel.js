      ...
      <div>
        <Drawer variant="permanent" classes={{paper: classes.drawerPaper}}>
          <AppBar className={classes.appbar} position="static" color="default">
            <Toolbar>
              <img className="logo" src="images/codeflow-logo.svg"/>
            </Toolbar>
          </AppBar>
          <div className="info-container">
            ...
            <div className="info-prompt">
              <img className={playIconClass} src="images/play.svg" onClick={this.handlePlay}/>
            </div>
            <div className="info-prompt">
              <img className={stopIconClass} src="images/stop.svg" onClick={this.handleStop}/>
            </div>
          </div>
