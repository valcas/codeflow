        ...
        <Drawer variant="permanent" classes={{paper: classes.drawerPaper}}>
          ...
          <div>
            <div className="info-container">
              <div className="info-prompt">Dynagram ID:</div>
              ...
              <div className="right-table-footer-content">
                <div className="info-container-right-footer">
                  ...
                  <div className="right-table-footer-icon-container">
                    <img className={renderInfo.filtericon} src="images/filter.svg" onClick={() => {this.filterHandler(processId)}}/>
                    <img className={renderInfo.removefiltericon} src="images/filter-remove.svg" onClick={() => {this.removeFilterHandler(processId)}}/>
                  </div>
                </div>
              </div>
            </div>
